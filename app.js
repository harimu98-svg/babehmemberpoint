...
function setupEventListeners() {
    ...
    // Tombol utama
    document.getElementById('btnOlsera').addEventListener('click', () => showModal('modalOlsera'));
    document.getElementById('btnDigital').addEventListener('click', () => showModal('modalDigital'));
    document.getElementById('btnMigrasi').addEventListener('click', () => showModal('modalMigrasi'));
    ...
    // Tombol search
    document.querySelector('button[onclick="searchCustomerLama()"]').onclick = () => searchCustomer('lama');
    document.querySelector('button[onclick="searchCustomerBaru()"]').onclick = () => searchCustomer('baru');
}
...
function updateButtons() {
    ...
    document.getElementById('btnOlsera').disabled = !enabled;
    document.getElementById('btnDigital').disabled = !enabled;
    document.getElementById('btnMigrasi').disabled = !enabled;
}
...
async function loadTableData(type, search = '') {
    ...
    try {
        ...
        showError(`Gagal memuat data ${type}`);
    } finally {
        showLoading(false);
    }
}
...
async function searchCustomer(type) {
    ...
    try {
        ...
        showWarning(`Gagal mencari customer ${type}`);
    } finally {
        showLoading(false);
    }
}
